...
| 类型 | 视觉特征 | 字体分工 | 适用内容 |
|------|---------|---------|---------|
| 开场封面 | 渐变背景 + 超大标题 | 标题:加粗 副标:等宽 | 全局封面 |
| 章节幕封 | 等宽章节号 + 大标题 + 大量留白 | 章节号:等宽 标题:加粗 | 章节分隔 |
| 数据大字报 | 超大数字 + 简短标签 | 数字:等宽 标签:加粗 | 核心指标展示 |
| 悬念问题 | 居中大问句 + 极简装饰 | 问句:加粗 装饰:等宽 | 抛出关键问题 |
| 大引用 | 超大引号 + 引文 + 出处 | 引文:加粗 出处:等宽 | 金句/名人名言 |
...
- 标题 text: font-family="'Microsoft YaHei', sans-serif", font-size=48-56, font-weight=700
...
- 标题 text: font-family="'Microsoft YaHei', sans-serif", font-size=40-48, font-weight=700, 居中
...
- 标签 text: font-family="'Microsoft YaHei', sans-serif", font-size=20
...
元素清单：
- 背景 rect: 全屏, fill=背景色
- 问句 text: font-family="'Microsoft YaHei', sans-serif", font-size=36-44, font-weight=700
...
┌──────────────────────────────────────┐
│                                      │
│   "                                  │  ← 加粗, 72px, 主色, opacity 0.3
│     最好的预测未来的方式                │  ← 加粗, 24-28px
│     就是创造未来。                     │
│                                      │
...
元素清单：
- 背景 rect: 全屏, fill=背景色
- 大引号 text: font-family="'Microsoft YaHei', sans-serif", font-size=72, fill=主色, opacity=0.3
- 引文 text: font-family="'Microsoft YaHei', sans-serif", font-size=24-28
