...
pres.layout = 'LAYOUT_16x9';  // 必须用 LAYOUT_16x9（10"×5.625"），不要用 LAYOUT_WIDE
...
- `LAYOUT_16x9`: 10" x 5.625" (**默认·推荐·所有 slide 代码按此设计**)
- `LAYOUT_16x10`: 10" x 6.25"
- `LAYOUT_4x3`: 10" x 7.5"
- `LAYOUT_WIDE`: 13.3" x 7.5" (**不要用**——与 slide 代码坐标体系不匹配，会导致内容只占画面 75%)
...
- **Layouts**: LAYOUT_16x9 (10"x5.625") ← 必须用此布局
